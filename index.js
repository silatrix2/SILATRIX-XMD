...
async function startGodszealBotInc() {
    ...
    GodszealBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: SILA TECH`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: Silatrix2`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: Sila MD`))
